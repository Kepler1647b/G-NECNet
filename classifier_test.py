...
from NETU_classifier.Dataloader_test import Dataset_test
...
if __name__ == '__main__':
    ...
    for t in ['ELSE', 'NETU']:
        ...
        for case_name in test_cases[t]:
            ...
            #      '{}_{}_{}.jpeg'.format(case_name, groundtruth, 'NETU' if average[1] > 0.5 else 'ELSE')))
            # plt.close()
    ...
    r = TP / (TP + FN)
    F1 = 2 * r * p / (r + p)
    print('NETU: precision: {:.4f}, recall: {:.4f}, F1: {:.4f}'.format(p, r, F1))
